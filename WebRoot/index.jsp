...
<head>
	...
	<script src="_js/billList.js"></script>
...
<body>
	<nav id="navbar" class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			...
			<ul id="mainNav" class="nav navbar-nav">
				<li class="active"><a href="index.jsp">定值单</a></li>
			</ul>
	...
	<div id="mainContent" class="row">
		<div id="billList" class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
			<div id="toolbar">
				<a class="btn btn-primary" id="addBill">
		...
		<div id="preview" class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
			<p id="preview_placeholder">请从左边列表中选择一张定值单</p>
			<!-- <div id="option"></div>
			<fieldset id="history"></fieldset>
			<fieldset id="brief"></fieldset>
